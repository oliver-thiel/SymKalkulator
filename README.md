...
## Example
The following screenshots show how you can calculate the volume of a cone with a base radius of 2.5 cm and a height of 3.8 cm:

Type in `1/3`:![Screenshot of SymKalkulator. 1/3 is typed in.](/screenshots/Skjermbilde1.png)

Type in `pi`:![Screenshot of SymKalkulator. Pi is is typed in.](/screenshots/Skjermbilde%202025-10-02%20114033.png)

Type in `*`:![Screenshot of SymKalkulator. * is typed in to multiply 1/3 and pi.](/screenshots/Skjermbilde2.png)

Type in `2,5  cm`:![Screenshot of SymKalkulator. 2,5  cm is typed in.](/screenshots/Skjermbilde3.png)

Type in `2**`:![Screenshot of SymKalkulator. 2** is typed in to square 2.5.](/screenshots/Skjermbilde4.png)

Type in `*`:![Screenshot of SymKalkulator. * is typed in to multiply pi/3 and 6.25.](/screenshots/Skjermbilde5.png)

Type in `3,8  cm`:![Screenshot of SymKalkulator. 3,8* is typed in to multiply 25pi/12 with 3.8.](/screenshots/Skjermbilde6.png)

Type in `*`:![Screenshot of SymKalkulator. * is typed in to multiply 25pi/12 squarecentimeters and 3.8 centimeters.](/screenshots/Skjermbilde7.png)

The result is exactly 95π/12 cubic centimeters or 24.870941840919196471162593450963 cubic centimeters with an error of plus or minus 1e-30:![Screenshot of SymKalkulator. The result is 95pi/12 cubic centimeters or 24.870941840919196471162593450963 with an error of 1e-30.](/screenshots/Skjermbilde8.png)
